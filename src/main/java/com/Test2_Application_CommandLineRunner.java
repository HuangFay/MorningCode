...
public class Test2_Application_CommandLineRunner implements CommandLineRunner {
	...
	public static void main(String[] args) {
        SpringApplication.run(Test2_Application_CommandLineRunner.class);
    }
...
//		repository.deleteByEmpId(4);
    	...
    	Optional<FuncVO> optional = repository.findById(1);
		FuncVO funcVO3 = optional.get();
		System.out.print(funcVO3.getFunctionId() + ",");
		System.out.print(funcVO3.getFunctionName() + ",");
...
//		System.out.print(empVO3.getDeptVO().getLoc());
    	...
    	List<FuncVO> list = repository.findAll();
		for (FuncVO aFunc : list) {
			System.out.print(aFunc.getFunctionId() + ",");
			System.out.print(aFunc.getFunctionName() + ",");
